...
struct SupportedPlateform(String);
struct Dynamic(String);
struct Platform(String);
struct RequiresDist(String);
struct RequiresExternal(String);
struct ProjectURL(String);
struct ProvidesExtra(String);
struct ProvidesDist(String);
...
struct CoreMetadata {
    ...
    requires_dists: Vec<RequiresDist>,
    ...
    requires_externals: Vec<RequiresExternal>,
    ...
    provides_extras: Vec<ProvidesExtra>,
    ...
    provides_dists: Vec<ProvidesDist>,
    ...
    // 
    obsoletes_dists: Vec<ObsoletesDist>,
}
